  ...
  return (
    <div className="content-box split-box">
        ...
        <div>
          ...
          <p>
            ...
            <span style={{ fontSize: 14 }}>
              *Ermäßigungsberechtigt sind Studierende, Senior:innen, Schüler:innen, Auszubildende, Erwerbslose, Menschen mit Schwerbehinderung (ab GdB
              50; bei eingetragenem Merkzeichen „B“ erhält eine Begleitperson freien Eintritt).
              <br />
      ...
      <div className="shop-container">
        <Ticketshop/>
{/* 
        <div className="no-load-tip">Falls der Ticketshop nicht lädt, aktualisiere bitte die Seite, in dem du auf F5 oder auf aktualisieren in deinem Browser klickst.</div>
