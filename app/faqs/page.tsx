...
const Faqs = () => {
    return (
        <div className="boring-page-wrapper">
            ...
            <p>  A: Die Tickets werden für den Freitag 15€ (ermäßigt 10€) und für den Samstag 20€ (ermäßigt 14€) kosten.
                ...
                Bitte vorher ein kostenloses Online-Ticket bestellen. </p>

            <h3>F: Wann beginnt das Festival jeweils an den beiden Tagen? </h3>

                <p>A:  Am Freitag beginnt der Einlass um 16  Uhr und das Programm endet um 1 Uhr nachts.
            ...
            A: Ja, durch ein oder zwei der Teleskope wird man sehen können. Teilweise werden diese aber noch für Forschung und Lehre verwendet, daher sind nicht alle Teleskope und ihre Kuppelgebäude für Besucher*innen zugänglich. Außerdem muss bedacht werden, dass es im Juli erst spät dunkel wird, sodass sich der Blick durch’s Teleskop zum Teil erst ab 22 bis 23 Uhr lohnt.
            ...
            A: Es wird die Möglichkeit zum kontaktlosen Bezahlen geben, jedoch nicht überall. Vor allem beim Essensangebot ist Bargeld nötig. Bringt also genug mit, damit ihr nicht auf einen leckeren Snack oder ein erfrischendes Getränk verzichten müsst.

                <h3> F: Kann ich mein Getränk mit zu den einzelnen Konzerten und Beiträgen nehmen?</h3>
            A: Bei einem Konzert auf der Außenbühne ist das kein Problem, es dürfen aber keine Speisen oder Getränke mit in die Innenräume der Sternwartengebäude genommen werden. Das gilt dann auch für die Konzerte im Großen Refraktor, dem OLT und der Bibliothek.
            ...
            <br/> <br/>
            Hast du noch mehr Fragen? Dann schreibe uns eine kurze Mail unter info@sternstundenfestival.de oder besuche uns auf <a href="https://www.instagram.com/sternstundenfestival/">
