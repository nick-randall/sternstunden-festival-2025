...
const Anfahrt = () => {
  return (
    <div className="boring-page-wrapper">
      ...
      <p>
        Das Gelände der Sternwarte erreicht ihr am besten vom Bahnhof Bergedorf mit dem Bus der Linie 332 zur Haltestelle Sternwarte (Universität).
        <Spacer height={16} />
      ...
      <Image src="/anfahrt.jpg" width="700" height="471" alt="Anfahrt Sternstunden Festival" />
    </div>
  );
};
